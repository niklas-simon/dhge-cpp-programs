...
Rect::Rect(const Color &_color, int _posX, int _posY, int _speedX, int _speedY,
           int _width, int _height, int z_index)
...
void Rect::draw()
{
        ...
        sdlDrawRect(posX, posY, width / 2, height / 2, color.getR(),
