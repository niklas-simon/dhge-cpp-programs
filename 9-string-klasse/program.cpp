...
int main()
{
        ...
        cout << "'" << bb << "' sind " << (!bb ? "auch" : "nicht") << " leer."
             << endl;
        cout << "'" << a << "' und '" << b << "' sind "
             << ((a == b) ? "gleich" : "verschieden") << "." << endl;
        cout << "'" << bb << "' sind " << (bb < k ? "kleiner" : "groesser")
             << " als '" << k << "'" << endl;
        cout << "'" << k << "' ist " << (k < b ? "kleiner" : "groesser")
             << " als '" << b << "'" << endl;
        cout << "'" << aa << "' plus '" << bb << "' sind '" << res << "'."
             << endl;
        cout << "Sind es wirklich 'ApfelBirnen'? "
             << ((ab == res) ? "Ja!" : "Nein???") << endl;
